...
export function useRoom() {
  ...
  useEffect(() => {
    const roomRef = ref(database, `rooms/${roomId}/aderidos/question`);
      ...
      const parsedQuestions = Object.entries(firebaseQuestions).map(([key, value]) => {
        return {
          ...
          H_Organizacoes_Parceiras: {
            ...
            questao50: {
              a_id: value.H_Organizacoes_Parceiras.questao50.a_id,
              b_inputOne: value.H_Organizacoes_Parceiras.questao50.b_inputOne,
              c_inputTwo: value.H_Organizacoes_Parceiras.questao50.c_inputTwo,
              d_inputThree: value.H_Organizacoes_Parceiras.questao50.d_inputThree,
            },
            questao51: value.H_Organizacoes_Parceiras.questao51,
            questao52: value.H_Organizacoes_Parceiras.questao52,
          },
          I_Recursos_E_Custos: {
            questao53: {
              a_proximidadeDomicilioFamilia: value.I_Recursos_E_Custos.questao53.a_proximidadeDomicilioFamilia,
              b_proximidadeDomicilioVisitadores: value.I_Recursos_E_Custos.questao53.b_proximidadeDomicilioVisitadores,
              c_caracteristicasCrianca: value.I_Recursos_E_Custos.questao53.c_caracteristicasCrianca,
              d_atribuicaoPorVaga: value.I_Recursos_E_Custos.questao53.d_atribuicaoPorVaga,
              e_sorteio: value.I_Recursos_E_Custos.questao53.e_sorteio,
              f_outroDistribuicao: value.I_Recursos_E_Custos.questao53.f_outroDistribuicao,
              g_outroDistribuicaoText: value.I_Recursos_E_Custos.questao53.g_outroDistribuicaoText,
            },
            questao54: value.I_Recursos_E_Custos.questao54,
          },
          J_Outros_Custos: {
            questao55: {
              a_id: value.J_Outros_Custos.questao55.a_id,
              b_inputOne: value.J_Outros_Custos.questao55.b_inputOne,
              c_inputTwo: value.J_Outros_Custos.questao55.c_inputTwo,
              d_inputThree: value.J_Outros_Custos.questao55.d_inputThree,
              e_inputFour: value.J_Outros_Custos.questao55.e_inputFour,
              f_inputFive: value.J_Outros_Custos.questao55.f_inputFive,
              g_inputSix: value.J_Outros_Custos.questao55.g_inputSix,
            },
            questao56: value.J_Outros_Custos.questao56,
            questao57: value.J_Outros_Custos.questao57,
            questao58: {
              a_id: value.J_Outros_Custos.questao58.a_id,
              b_inputOne: value.J_Outros_Custos.questao58.b_inputOne,
              c_inputTwo: value.J_Outros_Custos.questao58.c_inputTwo,
            },
            questao59: {
              a_id: value.J_Outros_Custos.questao59.a_id,
              b_inputOne: value.J_Outros_Custos.questao59.b_inputOne,
              c_inputTwo: value.J_Outros_Custos.questao59.c_inputTwo,
            },
            questao60: value.J_Outros_Custos.questao60,
          },
        };
      });
