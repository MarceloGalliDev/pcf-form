      ...
      onValue(roomRef, (room) => {
        ...
        const parsedQuestions = Object.entries(firebaseQuestions).map(([key, value]) => {
          return {
            ...
            B_Caracteristicas_do_PCF: {
              questao07: value?.B_Caracteristicas_do_PCF?.questao07 || null,
              questao08: value?.B_Caracteristicas_do_PCF?.questao08 || null,
              questao09: value?.B_Caracteristicas_do_PCF?.questao09 || null,
              questao10: value?.B_Caracteristicas_do_PCF?.questao10 || null,
              questao11: value?.B_Caracteristicas_do_PCF?.questao11 || null,
              questao12: value?.B_Caracteristicas_do_PCF?.questao12 || null,
              questao13: value?.B_Caracteristicas_do_PCF?.questao13 || null,
            },
            C_Gestao_do_PCF: {
